                ...
                userRef.child(uid).get().addOnSuccessListener(snapshot -> {
                    if (snapshot.exists()) {
                        ...
                        if ("Participant".equalsIgnoreCase(role)) {
                            intent = new Intent(LoginActivity.this, ParticipantEventBoardActivity.class);
                        } else if ("Organizer".equalsIgnoreCase(role)) {
                            intent = new Intent(LoginActivity.this, OrganizerActivity.class); // or OrganizerHomeActivity if you have it
                        } else if ("Admin".equalsIgnoreCase(role)) {
                            intent = new Intent(LoginActivity.this, WelcomeActivity.class); // or AdminDashboardActivity
                        } else {
                            intent = new Intent(LoginActivity.this, WelcomeActivity.class); // fallback
                        }
